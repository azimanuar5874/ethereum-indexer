...
import com.rarible.protocol.nft.core.service.item.meta.ItemMetaExtenderHandler
...
class ProducerConfiguration(
    ...
    fun protocolNftEventPublisher(producerFactory: ProducerFactory): ProtocolNftEventPublisher {
        return ProtocolNftEventPublisher(
            ...
            producerFactory.createInternalItemEventsWithoutMetaProducer(),
    ...
    @Bean
    fun itemMetaExtenderWorker(itemMetaExtenderHandler: ItemMetaExtenderHandler): BatchedConsumerWorker<NftItemEventDto> {
        ...
        val workers = (1..properties.nftItemMetaExtenderWorkersCount).map {
            ConsumerWorker(
                consumer = ItemMetaExtenderHandler.createItemMetaExtenderConsumer(
                    applicationEnvironmentInfo,
                    properties.blockchain,
                    properties.kafkaReplicaSet
                ),
                properties = properties.daemonWorkerProperties,
                eventHandler = itemMetaExtenderHandler,
